...
There are several possibilities for expanding on the regressions. One might wonder if it could be possible to say something about the expected changes in price in the future for a car you are looking to buy today, for instance. Let's say you want to buy a family car today, but you only need it for four years. Wouldn't it be interesting to know what you could be expected to get for it after those four years? Such a calculator could then even advice you whether or not you should lease a car instead of buying one.
